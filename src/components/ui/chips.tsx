  ...
  "inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        public: "border border-primary bg-primary text-primary-foreground",
        private: "border-transparent bg-red-500 text-white",
        draft: "border-transparent bg-secondary text-secondary-foreground",
        unlisted: "border-transparent bg-blue-800 text-white",
      },
    },
    defaultVariants: {
      variant: "default",
